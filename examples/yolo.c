...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        image saveimage;
        //draw_detections(im, dets, l.side*l.side*l.n, thresh, coco_classes, alphabet, 80,0.0,0.0,&save_iamge_name,&saveimage);
        draw_detections(im, dets, l.side*l.side*l.n, thresh, voc_names, alphabet, 20,0.0,0.0,&save_iamge_name,&saveimage);
